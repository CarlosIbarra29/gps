...
class Application_Model_GpsSitioModel extends Zend_Db_Table_Abstract{
    ...
    public function asignacionpersonalopvac($post,$table,$name_sitio,$id,$proyecto){
        $status_cuadrilla = 1;
        $proyec = 4444444;
        try {
            $db = Zend_Db_Table::getDefaultAdapter();
    ...
    public function asignacionpersonaloptalfor($post,$table,$name_sitio,$id,$proyecto){
        $status_cuadrilla = 1;
        $proyec = 5555555;
        try {
            $db = Zend_Db_Table::getDefaultAdapter();
    ...
    public function asignacionpersonalasitioindopvac($post,$table,$name_sitio,$fecha_inicial,$fecha_final,$sitio){
        $status_cuadrilla = 1;
        $proyect = 4444444;
        try {
            $db = Zend_Db_Table::getDefaultAdapter();
    ...
    public function asignacionpersonalasitioindoptalfor($post,$table,$name_sitio,$fecha_inicial,$fecha_final,$sitio){
        $status_cuadrilla = 1;
        $proyect = 5555555;
        try {
            $db = Zend_Db_Table::getDefaultAdapter();
