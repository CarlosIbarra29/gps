...
class Application_Model_GpsEnvioModel extends Zend_Db_Table_Abstract{
    ...
    public function getstepunoenvio(){ 
        try{
            ...
            $qry = $db->query("SELECT e.id, e.id_sitio, e.name_sitio, e.id_cliente, e.fecha_solicitud, e.fecha_envio, 
				e.user_solicitud, e.id_user, e.prioridad, e.tipo_envio, e.vehiculo FROM envios_solicitud e where e.step_envio = 0;");
            $row = $qry->fetchAll();
            return $row;
            $db->closeConnection();
        }catch (Exception $e){
    ...
    public function getsteponepaginator($id,$offset,$no_of_records_per_page){
        try{
            $db = Zend_Db_Table::getDefaultAdapter();
            $qry = $db->query("SELECT e.id, e.id_sitio, e.name_sitio, e.id_cliente, e.fecha_solicitud, e.fecha_envio, 
				e.user_solicitud, e.id_user, e.prioridad, e.tipo_envio, e.vehiculo FROM envios_solicitud e where e.step_envio = 0 AND e.id_user = ? order by e.id DESC LIMIT $offset,$no_of_records_per_page",array($id));
            $row = $qry->fetchAll();
            return $row;
            $db->closeConnection();
        }catch (Exception $e){
    ...
    public function getsolicitudstepone($step,$status){ 
        try{
            ...
            $qry = $db->query("SELECT e.id, e.id_sitio, e.name_sitio, e.id_cliente, e.fecha_solicitud, e.fecha_envio, 
                    ...
                    e.descripcion, e.contacto, e.peso_aproximado, e.dimensiones, e.comentarios, e.status_solicitud, e.vehiculo_final, e.operador, e.acuse, e.id_tipoproyecto
                    FROM envios_solicitud e where step_envio = ? and status_solicitud = ?;",array($step,$status));
            $row = $qry->fetchAll();
            return $row;
            $db->closeConnection();
        }catch (Exception $e){
    ...
    public function getsolicitudsteponeuser($step,$status,$user){ 
        try{
            ...
            $qry = $db->query("SELECT e.id, e.id_sitio, e.name_sitio, e.id_cliente, e.fecha_solicitud, e.fecha_envio, 
                    ...
                    FROM envios_solicitud e where step_envio = ? and status_solicitud = ? and id_user = ?",array($step,$status,$user));
            $row = $qry->fetchAll();
            return $row;
            $db->closeConnection();
        }catch (Exception $e){
    ...
    public function getenviosteponepaginatoruser($step,$status,$user,$offset,$no_of_records_per_page){
        try{
            ...
            $qry = $db->query("SELECT e.id, e.id_sitio, e.name_sitio, e.id_cliente, e.fecha_solicitud, e.fecha_envio, 
                    e.user_solicitud,e.id_user, e.prioridad, e.tipo_envio, e.vehiculo, e.direccion, e.step_envio, 
                    e.hora_entrega, e.descripcion, e.contacto, e.peso_aproximado, e.dimensiones, e.comentarios,
                    e.status_solicitud, e.vehiculo_final, e.operador, e.acuse, e.id_tipoproyecto, year(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS years, month(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS mes,day(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS dia
                    FROM envios_solicitud e where step_envio = ? and status_solicitud = ? and id_user = ? ORDER BY years, mes, dia ASC LIMIT $offset,$no_of_records_per_page",array($step,$status,$user));
            $row = $qry->fetchAll();
            return $row;
            $db->closeConnection();
        }catch (Exception $e){
    ...
    public function getsitioenviossearch($step,$status,$sitio){
        try{
            ...
            $qry = $db->query("SELECT e.id, e.id_sitio, e.name_sitio, e.id_cliente, e.fecha_solicitud, e.fecha_envio, 
                    e.user_solicitud, e.prioridad, e.tipo_envio, e.vehiculo, e.direccion, e.step_envio, e.hora_entrega, 
                    e.descripcion, e.contacto, e.peso_aproximado, e.dimensiones, e.comentarios, e.status_solicitud, e.vehiculo_final, e.operador, e.acuse,e.descripcion, e.id_tipoproyecto, year(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS years, month(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS mes,day(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS dia
                    FROM envios_solicitud e where step_envio = ? and status_solicitud = ? and name_sitio like '%{$sitio}%'
    ...
    public function getuserenviossearch($step,$status,$user){
        try{
            ...
            $qry = $db->query("SELECT e.id, e.id_sitio, e.name_sitio, e.id_cliente, e.fecha_solicitud, e.fecha_envio, 
                    e.user_solicitud, e.prioridad, e.tipo_envio, e.vehiculo, e.direccion, e.step_envio, e.hora_entrega, 
                    e.descripcion, e.contacto, e.peso_aproximado, e.dimensiones, e.comentarios, e.status_solicitud, e.vehiculo_final, e.operador, e.acuse,e.descripcion, e.id_tipoproyecto, year(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS years, month(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS mes,day(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS dia
                    FROM envios_solicitud e where step_envio = ? and status_solicitud = ? and user_solicitud  like '%{$user}%'
                    ORDER BY years,mes, dia ASC",array($step,$status));
            $row = $qry->fetchAll();
            return $row;
            $db->closeConnection();
    ...
    public function getprioridadenviossearch($step,$status,$prioridad){
        try{
            ...
            $qry = $db->query("SELECT e.id, e.id_sitio, e.name_sitio, e.id_cliente, e.fecha_solicitud, e.fecha_envio, 
                    e.user_solicitud, e.prioridad, e.tipo_envio, e.vehiculo, e.direccion, e.step_envio, e.hora_entrega, 
                    e.descripcion, e.contacto, e.peso_aproximado, e.dimensiones, e.comentarios, e.status_solicitud, e.vehiculo_final, e.operador, e.acuse,e.descripcion, e.id_tipoproyecto, year(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS years, month(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS mes,day(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS dia
                    FROM envios_solicitud e where step_envio = ? and status_solicitud = ? and e.prioridad =?
    ...
    public function gettipoenvidiadenviossearch($step,$status,$envio){
        try{
            ...
            $qry = $db->query("SELECT e.id, e.id_sitio, e.name_sitio, e.id_cliente, e.fecha_solicitud, e.fecha_envio, 
                    e.user_solicitud, e.prioridad, e.tipo_envio, e.vehiculo, e.direccion, e.step_envio, e.hora_entrega, 
                    e.descripcion, e.contacto, e.peso_aproximado, e.dimensiones, e.comentarios, e.status_solicitud, e.vehiculo_final, e.operador, e.acuse,e.descripcion, e.id_tipoproyecto, year(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS years, month(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS mes,day(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS dia
                    FROM envios_solicitud e where step_envio = ? and status_solicitud = ? and tipo_envio =?
    ...
    public function gettipsolicitudenviossearch($step,$status,$solicitud){
        try{
            ...
            $qry = $db->query("SELECT e.id, e.id_sitio, e.name_sitio, e.id_cliente, e.fecha_solicitud, e.fecha_envio, 
                    e.user_solicitud, e.prioridad, e.tipo_envio, e.vehiculo, e.direccion, e.step_envio, e.hora_entrega, 
                    e.descripcion, e.contacto, e.peso_aproximado, e.dimensiones, e.comentarios, e.status_solicitud, e.vehiculo_final, e.operador, e.acuse,e.descripcion, e.id_tipoproyecto, year(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS years, month(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS mes,day(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS dia
                    FROM envios_solicitud e where step_envio = ? and status_solicitud = ? and e.id =?
    ...
    public function getfechaenviossearch($step,$status,$fecha){
        try{
            ...
            $qry = $db->query("SELECT e.id, e.id_sitio, e.name_sitio, e.id_cliente, e.fecha_solicitud, e.fecha_envio, 
                    e.user_solicitud, e.prioridad, e.tipo_envio, e.vehiculo, e.direccion, e.step_envio, e.hora_entrega, 
                    e.descripcion, e.contacto, e.peso_aproximado, e.dimensiones, e.comentarios, e.status_solicitud, e.vehiculo_final, e.operador, e.acuse,e.descripcion, e.id_tipoproyecto, year(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS years, month(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS mes,day(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS dia
                    FROM envios_solicitud e where step_envio = ? and status_solicitud = ? and fecha_solicitud= ? 
    ...
    public function getfechaenviopaginatoruser($step,$status,$fecha,$offset,$no_of_records_per_page){
        try{
            ...
            $qry = $db->query("SELECT e.id, e.id_sitio, e.name_sitio, e.id_cliente, e.fecha_solicitud, e.fecha_envio, 
                    ...
                    e.hora_entrega, e.descripcion, e.contacto, e.peso_aproximado, e.dimensiones, e.comentarios,
                    e.status_solicitud, e.vehiculo_final, e.operador, e.acuse, e.id_tipoproyecto, year(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS years, month(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS mes,day(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS dia
                    FROM envios_solicitud e where step_envio = ? and status_solicitud = ? and fecha_solicitud = ? ORDER BY years, mes, dia ASC LIMIT $offset,$no_of_records_per_page",array($step,$status,$fecha));
            $row = $qry->fetchAll();
            return $row;
            $db->closeConnection();
        }catch (Exception $e){
    ...
    public function getprioridadenviopaginator($step,$status,$prioridad,$offset,$no_of_records_per_page){
        try{
            ...
            $qry = $db->query("SELECT e.id, e.id_sitio, e.name_sitio, e.id_cliente, e.fecha_solicitud, e.fecha_envio, 
                    ...
                    e.descripcion, e.contacto, e.peso_aproximado, e.dimensiones, e.comentarios, e.status_solicitud, e.vehiculo_final, e.operador, e.acuse,e.descripcion, e.id_tipoproyecto, year(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS years, month(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS mes,day(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS dia
                    FROM envios_solicitud e where step_envio = ? and status_solicitud = ? and e.prioridad = ?
                    ORDER BY years,mes, dia ASC LIMIT $offset,$no_of_records_per_page",array($step,$status,$prioridad));
            $row = $qry->fetchAll();
            return $row;
            $db->closeConnection();
        }catch (Exception $e){
    ...
    public function gettipoenvioenviopaginator($step,$status,$envio,$offset,$no_of_records_per_page){
        try{
            ...
            $qry = $db->query("SELECT e.id, e.id_sitio, e.name_sitio, e.id_cliente, e.fecha_solicitud, e.fecha_envio, 
                    ...
                    e.descripcion, e.contacto, e.peso_aproximado, e.dimensiones, e.comentarios, e.status_solicitud, e.vehiculo_final, e.operador, e.acuse,e.descripcion, e.id_tipoproyecto, year(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS years, month(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS mes,day(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS dia
                    FROM envios_solicitud e where step_envio = ? and status_solicitud = ? and tipo_envio = ?
                    ORDER BY years,mes, dia ASC LIMIT $offset,$no_of_records_per_page",array($step,$status,$envio));
            $row = $qry->fetchAll();
            return $row;
            $db->closeConnection();
        }catch (Exception $e){
    ...
    public function gettiposolicitudenviopaginator($step,$status,$solicitud,$offset,$no_of_records_per_page){
        try{
            ...
            $qry = $db->query("SELECT e.id, e.id_sitio, e.name_sitio, e.id_cliente, e.fecha_solicitud, e.fecha_envio, 
                    ...
                    e.descripcion, e.contacto, e.peso_aproximado, e.dimensiones, e.comentarios, e.status_solicitud, e.vehiculo_final, e.operador, e.acuse,e.descripcion, e.id_tipoproyecto, year(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS years, month(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS mes,day(date(CONCAT(SUBSTRING(fecha_solicitud, 7, 4),  '-', SUBSTRING(fecha_solicitud, 4, 2), '-', SUBSTRING(fecha_solicitud, 1, 2)))) AS dia
                    FROM envios_solicitud e where step_envio = ? and status_solicitud = ? and e.id = ?
                    ORDER BY years,mes, dia ASC LIMIT $offset,$no_of_records_per_page",array($step,$status,$solicitud));
            $row = $qry->fetchAll();
            return $row;
            $db->closeConnection();
        }catch (Exception $e){
    ...
    public function getfechalogistica($fecha,$vehiculo){
        ...
        try{
            $db = Zend_Db_Table::getDefaultAdapter();
            $qry = $db->query("SELECT e.id as No_envio,e.name_sitio as Sitio, e.direccion as Direccion, e.descripcion as Descripcion, e.peso_aproximado as Peso,e.dimensiones as Dimensiones, e.comentarios as Comentario 
                FROM envios_solicitud e  where e.fecha_solicitud= ? AND e.vehiculo = ? AND e.status_solicitud= ?"
    ...
    public function getfechalogisticados($fecha,$vehiculo){
        ...
        try{
            $db = Zend_Db_Table::getDefaultAdapter();
            $qry = $db->query("SELECT e.id as No_envio, e.name_sitio as Sitio, e.direccion as Direccion, e.descripcion as Descripcion, e.peso_aproximado as Peso,e.dimensiones as Dimensiones, e.comentarios as Comentario  FROM envios_solicitud e where e.fecha_solicitud= ? AND e.vehiculo_final = ? AND e.status_solicitud= ?",array($fecha,$vehiculo,$logistica));
            $row = $qry->fetchAll();
            return $row;
            $db->closeConnection();
        }catch (Exception $e){
    ...
    public function getinfoenvio(){
        try{
            $db = Zend_Db_Table::getDefaultAdapter();
            $qry = $db->query("SELECT e.id,e.id_sitio,e.name_sitio, e.id_cliente, e.fecha_solicitud, e.fecha_envio, 
                e.user_solicitud, e.prioridad, e.tipo_envio, e.vehiculo, e.direccion, e.hora_entrega, e.descripcion,
                e.contacto, e.peso_aproximado, e.dimensiones,e.comentarios, e.status_solicitud, e.user_auditoria, 
                e.fecha_auditoria, e.comentario_auditoria, e.nombre_operador, e.id_tipoproyecto, tp.nombre_proyecto,
                e.vehiculo_final
                FROM envios_solicitud e 
                LEFT JOIN sitios_tipoproyecto st on st.id = e.id_tipoproyecto 
                LEFT JOIN tipo_proyecto tp on tp.id =st.id_tipoproyecto where e.step_envio = 1");
            $row = $qry->fetchAll();
            return $row;
            $db->closeConnection();
        }catch (Exception $e){
